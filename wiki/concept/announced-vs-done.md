...
국정 업적을 읽을 때 가장 자주 무너지는 구분이다 — **법이 된 것, 시행된 것,
계획된 것, 합의문에 적힌 것은 서로 다른 무게를 갖는다.**
^[prosecution-reform#claim-law]

이 페이지는 2026-09-20 기준으로 소스들을 그 네 칸에 넣는다. ^[judicial-reform#claim-pass] 날짜가 지나면
칸이 바뀌므로, **읽는 날을 반드시 확인한다.**
...
| KTX·SRT 통합 운행 ^[rail-merger#claim-merge] | 2026-09-01 | [[source/rail-merger]] |
...
- **상장폐지 기준 강화** — 시가총액 기준이 2026년 7월 200억 원, 2027년 1월
  300억 원으로 올라간다. ^[stock-market#claim-delisting]
...
한-중앙아시아 정상회의의 **74건은 협정과 양해각서를 합한 수**이고,
양해각서는 법적 구속력이 없다. ^[resource-diplomacy#claim-central]

잣대가 이미 있다. 이명박 정부 자원외교의 양해각서 96건 중 본계약은
**16건**이었다. ^[resource-diplomacy#claim-mb-mou]
[[source/resource-diplomacy]]

협정으로 타결된 것은 다르다 — 아르헨티나 이중과세방지협정,
^[resource-diplomacy#claim-argentina] 투르크메니스탄 투자보호협정.
^[resource-diplomacy#claim-kazakh]

## 발표한 쪽의 숫자와 확인된 숫자가 다를 때
...
^[gyeonggi-construction#claim-poll] 대장동 환수 5,503억
^[daejangdong#claim-recovery-total] — 모두 **집행한 쪽이 내놓은 수치**이고
원본에 CLAIM으로 표시돼 있다.

## 시간이 더 필요한 것

- **KTX·SRT 통합** — 운행 18일째다. 정시성·혼잡도·요금 유지 여부 모두
  자료가 없다. ^[rail-merger#claim-fare]
- **주식시장** — 코스피는 2026-06-18 9,063.84로 고점을 찍고 07-29
  5,663.24까지 37.5% 내렸다. ^[stock-market#claim-drawdown] **지수는
  제도의 성적표가 아니다** — 어느 제도가 얼마나 작용했는지 위키는 모른다.
  ^[stock-market#claim-index-series]

## 왜 이 페이지가 필요한가

이 구분이 무너지면 위키는 보도자료 모음이 된다. 「했다」로 적힌 문장 하나가
다음 ingest에서 다른 페이지로 옮겨지고, 그때는 출처가 「위키에 그렇게 적혀
있다」가 된다. ^[prosecution-reform#claim-law]
