...
- [[concept/sources-and-weight]] — 자료의 무게. 앵커가 있다고 다 같은 근거가
  아니다. 4층이 유일 근거인 세 자리를 표시해 뒀다.
...
아직 만들 이유를 찾지 못했다 — 기관은 소스 페이지 안에서 설명된다.
[[synthesis/lint-2026-09-20]]이 그 판단을 적어 뒀다.

## 사건 (event)

- [[event/mideast-2026]] — 2026년 중동 무력 충돌. 사건이 아니라 **반응의
  연표**다 — 위키는 이 사건 자체를 다루는 소스가 없다.
...
- [[synthesis/what-he-is-trying-to-do]] — 「무엇을 이루려 하는가」. 목표·제도·
  아직 안 된 것을 세 층으로 갈라 답했다.
- [[synthesis/lint-2026-09-20]] — 사람이 읽어야 아는 검사 다섯. 고친 것
  넷, 세울 페이지 둘, 자료 공백 열여덟 자리.
